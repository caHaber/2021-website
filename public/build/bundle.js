...
var app = (function () {
    ...
    /* src/components/TeamNode.svelte generated by Svelte v3.31.0 */

    const { console: console_1 } = globals;
    const file$1 = "src/components/TeamNode.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	let text_1;
    	let t_value = /*d*/ ctx[10].data.Player + " " + /*moneyFormat*/ ctx[7](/*d*/ ctx[10].value) + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(rect0, "fill-opacity", "1");
    			attr_dev(rect0, "width", rect0_width_value = /*d*/ ctx[10].x1 - /*d*/ ctx[10].x0);
    			attr_dev(rect0, "height", rect0_height_value = (/*d*/ ctx[10].y1 - /*d*/ ctx[10].y0) / 2);
    			attr_dev(rect0, "fill", rect0_fill_value = /*colors*/ ctx[2].secondaryColor);
    			add_location(rect0, file$1, 41, 12, 1029);
    			attr_dev(rect1, "y", rect1_y_value = /*d*/ ctx[10].y1 / 2 - /*d*/ ctx[10].y0 / 2);
    			attr_dev(rect1, "fill-opacity", "1");
    			attr_dev(rect1, "width", rect1_width_value = /*d*/ ctx[10].x1 - /*d*/ ctx[10].x0);
    			attr_dev(rect1, "height", rect1_height_value = /*d*/ ctx[10].y1 / 2 - /*d*/ ctx[10].y0 / 2);
    			attr_dev(rect1, "fill", rect1_fill_value = /*colors*/ ctx[2].mainColor);
    			add_location(rect1, file$1, 47, 12, 1223);
    			attr_dev(clipPath, "id", clipPath_id_value = /*d*/ ctx[10].data.Player.replace(" ", "_"));
    			add_location(clipPath, file$1, 54, 12, 1447);
    			attr_dev(text_1, "class", "player-name svelte-ane4zw");
    			attr_dev(text_1, "fill", text_1_fill_value = "black");
    			attr_dev(text_1, "clip-path", text_1_clip_path_value = /*d*/ ctx[10].data.Player.replace(" ", "_"));
    			attr_dev(text_1, "dy", "-3");
    			attr_dev(text_1, "dx", "5");
    			add_location(text_1, file$1, 56, 12, 1510);
    			attr_dev(g, "transform", g_transform_value = `translate(${/*d*/ ctx[10].x0}, ${/*d*/ ctx[10].y0})`);
    			add_location(g, file$1, 40, 8, 971);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, rect0);
    			append_dev(g, rect1);
    			append_dev(g, clipPath);
    			append_dev(g, text_1);
    			append_dev(text_1, t);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*tree*/ 64 && rect0_width_value !== (rect0_width_value = /*d*/ ctx[10].x1 - /*d*/ ctx[10].x0)) {
    				attr_dev(rect0, "width", rect0_width_value);
    			}

    			if (dirty & /*tree*/ 64 && rect0_height_value !== (rect0_height_value = (/*d*/ ctx[10].y1 - /*d*/ ctx[10].y0) / 2)) {
    				attr_dev(rect0, "height", rect0_height_value);
    			}

    			if (dirty & /*colors*/ 4 && rect0_fill_value !== (rect0_fill_value = /*colors*/ ctx[2].secondaryColor)) {
    				attr_dev(rect0, "fill", rect0_fill_value);
    			}

    			if (dirty & /*tree*/ 64 && rect1_y_value !== (rect1_y_value = /*d*/ ctx[10].y1 / 2 - /*d*/ ctx[10].y0 / 2)) {
    				attr_dev(rect1, "y", rect1_y_value);
    			}

    			if (dirty & /*tree*/ 64 && rect1_width_value !== (rect1_width_value = /*d*/ ctx[10].x1 - /*d*/ ctx[10].x0)) {
    				attr_dev(rect1, "width", rect1_width_value);
    			}

    			if (dirty & /*tree*/ 64 && rect1_height_value !== (rect1_height_value = /*d*/ ctx[10].y1 / 2 - /*d*/ ctx[10].y0 / 2)) {
    				attr_dev(rect1, "height", rect1_height_value);
    			}

    			if (dirty & /*colors*/ 4 && rect1_fill_value !== (rect1_fill_value = /*colors*/ ctx[2].mainColor)) {
    				attr_dev(rect1, "fill", rect1_fill_value);
    			}

    			if (dirty & /*tree*/ 64 && clipPath_id_value !== (clipPath_id_value = /*d*/ ctx[10].data.Player.replace(" ", "_"))) {
    				attr_dev(clipPath, "id", clipPath_id_value);
    			}

    			if (dirty & /*tree*/ 64 && t_value !== (t_value = /*d*/ ctx[10].data.Player + " " + /*moneyFormat*/ ctx[7](/*d*/ ctx[10].value) + "")) set_data_dev(t, t_value);

    			if (dirty & /*tree*/ 64 && text_1_clip_path_value !== (text_1_clip_path_value = /*d*/ ctx[10].data.Player.replace(" ", "_"))) {
    				attr_dev(text_1, "clip-path", text_1_clip_path_value);
    			}

    			if (dirty & /*tree*/ 64 && g_transform_value !== (g_transform_value = `translate(${/*d*/ ctx[10].x0}, ${/*d*/ ctx[10].y0})`)) {
    ...
    // (39:4) {#each tree().leaves() as d, index (d)}
    function create_each_block(key_1, ctx) {
    	let first;
    	let if_block_anchor;
    	let if_block = /*d*/ ctx[10].value && create_if_block$1(ctx);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(39:4) {#each tree().leaves() as d, index (d)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	let t0;
    	let t1;
    	let t2_value = /*moneyFormat*/ ctx[7](sum(/*data*/ ctx[0], /*func*/ ctx[8])) + "";
    	let t2;
    	let t3;
    	let svg_1;
    	let each_blocks = [];
    	...
    	let each_value = /*tree*/ ctx[6]().leaves();
    	validate_each_argument(each_value);
    	const get_key = ctx => /*d*/ ctx[10];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$1, 33, 0, 759);
    			attr_dev(svg_1, "width", svg_1_width_value = /*dimensions*/ ctx[3].width);
    			attr_dev(svg_1, "height", svg_1_height_value = /*dimensions*/ ctx[3].height);
    			add_location(svg_1, file$1, 37, 0, 827);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*team*/ 16) set_data_dev(t0, /*team*/ ctx[4]);
    			if (dirty & /*data, year*/ 3 && t2_value !== (t2_value = /*moneyFormat*/ ctx[7](sum(/*data*/ ctx[0], /*func*/ ctx[8])) + "")) set_data_dev(t2, t2_value);

    			if (dirty & /*tree, moneyFormat, colors*/ 196) {
    				const each_value = /*tree*/ ctx[6]().leaves();
    				validate_each_argument(each_value);
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, svg_1, destroy_block, create_each_block, null, get_each_context);
    			}

    			if (dirty & /*dimensions*/ 8 && svg_1_width_value !== (svg_1_width_value = /*dimensions*/ ctx[3].width)) {
    				attr_dev(svg_1, "width", svg_1_width_value);
    			}

    			if (dirty & /*dimensions*/ 8 && svg_1_height_value !== (svg_1_height_value = /*dimensions*/ ctx[3].height)) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let { team } = $$props;
    	let svg;
    	const moneyFormat = format(".4s");
    	const writable_props = ["data", "year", "colors", "dimensions", "team"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<TeamNode> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*data, year, dimensions*/ 11) {
    			 $$invalidate(6, tree = function () {
    				let root = hierarchy({ name: "emojis", children: data }).sum(d => d[year]).sort((a, b) => b[year] - a[year]);

    				const treemap = index$4().size([dimensions.width, dimensions.height]).paddingInner(function (d) {
    					console.log(d);
    					return 20;
    				}).paddingOuter(20).tile(treemapSlice).round(false);
    ...
    class TeamNode extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*data*/ ctx[0] === undefined && !("data" in props)) {
    			console_1.warn("<TeamNode> was created without expected prop 'data'");
    		}

    		if (/*year*/ ctx[1] === undefined && !("year" in props)) {
    			console_1.warn("<TeamNode> was created without expected prop 'year'");
    		}

    		if (/*colors*/ ctx[2] === undefined && !("colors" in props)) {
    			console_1.warn("<TeamNode> was created without expected prop 'colors'");
    		}

    		if (/*dimensions*/ ctx[3] === undefined && !("dimensions" in props)) {
    			console_1.warn("<TeamNode> was created without expected prop 'dimensions'");
    		}

    		if (/*team*/ ctx[4] === undefined && !("team" in props)) {
    			console_1.warn("<TeamNode> was created without expected prop 'team'");
    		}
    	}

    	get data() {
    		throw new Error("<TeamNode>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set data(value) {
    		throw new Error("<TeamNode>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src/components/Team.svelte generated by Svelte v3.31.0 */
    const file$2 = "src/components/Team.svelte";

    // (53:4) {#if data && totals_value.length === 30}
    function create_if_block$2(ctx) {
    	let teamnode;
    	let updating_year;
    	let current;

    	function teamnode_year_binding(value) {
    		/*teamnode_year_binding*/ ctx[8].call(null, value);
    	}

    	let teamnode_props = {
    		dimensions: /*createDimensions*/ ctx[5](/*totals_value*/ ctx[4]),
    		data: /*data*/ ctx[3],
    		colors: /*colors*/ ctx[2],
    		team: /*team*/ ctx[1]
    	};
    	...
    	if (/*year*/ ctx[0] !== void 0) {
    		teamnode_props.year = /*year*/ ctx[0];
    	}

    	teamnode = new TeamNode({ props: teamnode_props, $$inline: true });
    	binding_callbacks.push(() => bind(teamnode, "year", teamnode_year_binding));

    	const block = {
    		c: function create() {
    			create_component(teamnode.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(teamnode, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const teamnode_changes = {};
    			if (dirty & /*createDimensions, totals_value*/ 48) teamnode_changes.dimensions = /*createDimensions*/ ctx[5](/*totals_value*/ ctx[4]);
    			if (dirty & /*data*/ 8) teamnode_changes.data = /*data*/ ctx[3];
    			if (dirty & /*colors*/ 4) teamnode_changes.colors = /*colors*/ ctx[2];
    			if (dirty & /*team*/ 2) teamnode_changes.team = /*team*/ ctx[1];

    			if (!updating_year && dirty & /*year*/ 1) {
    				updating_year = true;
    				teamnode_changes.year = /*year*/ ctx[0];
    				add_flush_callback(() => updating_year = false);
    			}

    			teamnode.$set(teamnode_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(teamnode.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(teamnode.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(teamnode, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(53:4) {#if data && totals_value.length === 30}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	let div;
    	let current;
    	let if_block = /*data*/ ctx[3] && /*totals_value*/ ctx[4].length === 30 && create_if_block$2(ctx);

    	const block = {
    		c: function create() {
    			div = element("div");
    			if (if_block) if_block.c();
    			attr_dev(div, "class", "team svelte-1e77zz0");
    			add_location(div, file$2, 51, 0, 1344);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*data*/ ctx[3] && /*totals_value*/ ctx[4].length === 30) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*data, totals_value*/ 24) {
    						transition_in(if_block, 1);
    					}
    				} else {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		const res = await csv$1(`/data/teams/${team}.csv`, parseData);
    		totals.update(arr => [...arr, res[res.length - 1]]);
    		$$invalidate(7, total_raw_data = res[res.length - 1]);
    		$$invalidate(3, data = res.splice(0, res.length - 1));
    	});
    	...
    	const writable_props = ["team", "colors", "year", "years"];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("total_raw_data" in $$props) $$invalidate(7, total_raw_data = $$props.total_raw_data);
    		if ("totals_value" in $$props) $$invalidate(4, totals_value = $$props.totals_value);
    		if ("createDimensions" in $$props) $$invalidate(5, createDimensions = $$props.createDimensions);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*year, total_raw_data*/ 129) {
    			 $$invalidate(5, createDimensions = function (totals_arr) {
    				let scale = linear$2().domain(extent(totals_arr, t => t[year])).range([MIN_HEIGHT, MAX_HEIGHT]);
    ...
    class Team extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { team: 1, colors: 2, year: 0, years: 6 });
    		...
    		if (/*colors*/ ctx[2] === undefined && !("colors" in props)) {
    			console.warn("<Team> was created without expected prop 'colors'");
    		}

    		if (/*year*/ ctx[0] === undefined && !("year" in props)) {
    			console.warn("<Team> was created without expected prop 'year'");
    		}

    		if (/*years*/ ctx[6] === undefined && !("years" in props)) {
    			console.warn("<Team> was created without expected prop 'years'");
    		}
    	}
    ...
    /* src/routes/Nba.svelte generated by Svelte v3.31.0 */
    const file$3 = "src/routes/Nba.svelte";
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$3, 43, 3, 904);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(43:2) {#each years as item}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const team_changes = {};
    			if (dirty & /*value*/ 1) team_changes.year = /*value*/ ctx[0];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(48:1) {#each nbateams as t}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 40, 1, 834);
    			if (/*value*/ ctx[0] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[2].call(select));
    			add_location(select, file$3, 41, 1, 857);
    			add_location(br, file$3, 46, 1, 964);
    			attr_dev(main, "class", "svelte-1bgjngj");
    			add_location(main, file$3, 39, 0, 826);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*value, years*/ 3) {
    				select_option(select, /*value*/ ctx[0]);
    			}

    			if (dirty & /*value, years, colors, nbateams*/ 3) {
    				each_value = nbateams;
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Nba> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("totals_value" in $$props) totals_value = $$props.totals_value;
    	...
    	return [value, years, select_change_handler];
    }
    ...
    // (60:14) <Link className="git" to="/basketball">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(60:14) <Link className=\\\"git\\\" to=\\\"/basketball\\\">",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p0 = element("p");
    			t2 = text("Engineer, designer, and visualization specialist. Focused on creating\n              unique experiences that communicate a human perspective.\n              ");
    			br1 = element("br");
    			t3 = space();
    			div5 = element("div");
    			div2 = element("div");
    			...
    			p1 = element("p");
    			a0 = element("a");
    			a0.textContent = "github/caHaber";
    			t7 = space();
    			p2 = element("p");
    			a1 = element("a");
    			a1.textContent = "haber.casey@gmail.com";
    			t9 = space();
    			p3 = element("p");
    			a2 = element("a");
    			t10 = text("Resume / CV");
    			...
    			p6 = element("p");
    			a4 = element("a");
    			a4.textContent = "VISSOFT '19 (Best short paper)";
    			t18 = space();
    			p7 = element("p");
    			a5 = element("a");
    			a5.textContent = "Programming Behaviors Blog Post";
    			t20 = space();
    			div4 = element("div");
    			h32 = element("h3");
    			h32.textContent = "2016 - 2017";
    			t22 = space();
    			p8 = element("p");
    			a6 = element("a");
    			a6.textContent = "Exploring Academic Outcomes";
    			t24 = space();
    			p9 = element("p");
    			a7 = element("a");
    			a7.textContent = "Housing Render Demo";
    			t26 = space();
    			p10 = element("p");
    			a8 = element("a");
    			a8.textContent = "Simple ReactD3 Demo";
    			t28 = space();
    			p11 = element("p");
    			a9 = element("a");
    			a9.textContent = "SVG Draw!";
    			t30 = space();
    			p12 = element("p");
    			a10 = element("a");
    			a10.textContent = "React Animations";
    			t32 = space();
    			p13 = element("p");
    			a11 = element("a");
    			a11.textContent = "Github Fetch";
    			attr_dev(img, "classname", "logo");
    			add_location(img, file$4, 9, 12, 210);
    			add_location(br0, file$4, 10, 12, 247);
    			add_location(br1, file$4, 15, 14, 1126);
    			attr_dev(p0, "classname", "bio bio0");
    			add_location(p0, file$4, 11, 12, 266);
    			attr_dev(div0, "classname", "paraT");
    			add_location(div0, file$4, 8, 10, 174);
    			attr_dev(div1, "classname", "col-md-5 content");
    			add_location(div1, file$4, 7, 8, 129);
    			add_location(h30, file$4, 22, 12, 1299);
    			attr_dev(a0, "classname", "git");
    			attr_dev(a0, "href", "http://www.github.com/caHaber");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$4, 25, 14, 1364);
    			attr_dev(p1, "classname", "link");
    			add_location(p1, file$4, 24, 12, 1329);
    			attr_dev(a1, "classname", "git");
    			attr_dev(a1, "href", "mailto:haber.casey@gmail.com");
    			add_location(a1, file$4, 33, 14, 1583);
    			attr_dev(p2, "classname", "link");
    			add_location(p2, file$4, 32, 12, 1548);
    			attr_dev(a2, "classname", "git");
    			attr_dev(a2, "href", a2_href_value = process.env.PUBLIC_URL + "/img/CaseyHaber_resume2019.pdf");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file$4, 39, 14, 1761);
    			attr_dev(p3, "classname", "link");
    			add_location(p3, file$4, 38, 12, 1726);
    			attr_dev(a3, "classname", "git");
    			attr_dev(a3, "href", "https://twitter.com/case_sqrd");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file$4, 47, 14, 2005);
    			attr_dev(p4, "classname", "link");
    			add_location(p4, file$4, 46, 12, 1970);
    			attr_dev(div2, "classname", "iconDiv contact-links col-md-12");
    			add_location(div2, file$4, 21, 10, 1237);
    			add_location(h31, file$4, 56, 12, 2258);
    			attr_dev(p5, "classname", "link");
    			add_location(p5, file$4, 58, 12, 2292);
    			attr_dev(a4, "classname", "git");
    			attr_dev(a4, "href", "https://twosixtech.com/choosing-open-source-libraries-and-analyzing-risks/");
    			attr_dev(a4, "target", "_blank");
    			add_location(a4, file$4, 63, 14, 2451);
    			attr_dev(p6, "classname", "link");
    			add_location(p6, file$4, 62, 12, 2416);
    			attr_dev(a5, "classname", "git");
    			attr_dev(a5, "href", "https://twosixtech.com/visualizing-programming-behaviors-with-stack-overflow/");
    			attr_dev(a5, "target", "_blank");
    			add_location(a5, file$4, 72, 14, 2762);
    			attr_dev(p7, "classname", "link");
    			add_location(p7, file$4, 71, 12, 2727);
    			attr_dev(div3, "classname", "iconDiv recent-links col-md-12");
    			add_location(div3, file$4, 55, 10, 2197);
    			add_location(h32, file$4, 83, 12, 3120);
    			attr_dev(a6, "classname", "git");
    			attr_dev(a6, "href", "archive/SUYI");
    			attr_dev(a6, "target", "_blank");
    			add_location(a6, file$4, 85, 14, 3188);
    			attr_dev(p8, "classname", "link");
    			add_location(p8, file$4, 84, 12, 3153);
    			attr_dev(a7, "classname", "git react");
    			attr_dev(a7, "href", "archive/ZillowRenderDemo");
    			attr_dev(a7, "target", "_blank");
    			add_location(a7, file$4, 91, 14, 3372);
    			attr_dev(p9, "classname", "link");
    			add_location(p9, file$4, 90, 12, 3337);
    			attr_dev(a8, "classname", "git react");
    			attr_dev(a8, "title", "Simple React transitioning, filter and search");
    			attr_dev(a8, "href", "archive/Reactd3");
    			attr_dev(a8, "target", "_blank");
    			add_location(a8, file$4, 99, 14, 3597);
    			attr_dev(p10, "classname", "link");
    			add_location(p10, file$4, 98, 12, 3562);
    			attr_dev(a9, "classname", "git");
    			attr_dev(a9, "href", "archive/draw");
    			attr_dev(a9, "target", "_blank");
    			add_location(a9, file$4, 108, 14, 3883);
    			attr_dev(p11, "classname", "link");
    			add_location(p11, file$4, 107, 12, 3848);
    			attr_dev(a10, "classname", "git");
    			attr_dev(a10, "href", "archive/ReactAnimate");
    			attr_dev(a10, "target", "_blank");
    			add_location(a10, file$4, 114, 14, 4049);
    			attr_dev(p12, "classname", "link");
    			add_location(p12, file$4, 113, 12, 4014);
    			attr_dev(a11, "classname", "git react");
    			attr_dev(a11, "href", "archive/GitReact");
    			attr_dev(a11, "target", "_blank");
    			add_location(a11, file$4, 120, 14, 4230);
    			attr_dev(p13, "classname", "link");
    			add_location(p13, file$4, 119, 12, 4195);
    			attr_dev(div4, "classname", "iconDiv archive-links col-md-12");
    			add_location(div4, file$4, 82, 10, 3058);
    			attr_dev(div5, "classname", "col-md-7 link-div");
    			add_location(div5, file$4, 20, 8, 1191);
    			attr_dev(div6, "classname", "row");
    			add_location(div6, file$4, 6, 6, 99);
    			attr_dev(div7, "classname", "container-fluid");
    			attr_dev(div7, "id", "main");
    			add_location(div7, file$4, 5, 4, 49);
    			attr_dev(div8, "id", "home");
    			add_location(div8, file$4, 4, 2, 29);
    ...
    const file$5 = "src/components/NavLink.svelte";

    // (18:0) <Link to="{to}" getProps="{getProps}">
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(/*name*/ ctx[1]);
    			add_location(p, file$5, 18, 2, 461);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(18:0) <Link to=\\\"{to}\\\" getProps=\\\"{getProps}\\\">",
    		ctx
    	});
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Link: Link$1, to, name, getProps });
    ...
    class NavLink extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { to: 0, name: 1 });
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			mount_component(nba, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    		...
    		d: function destroy(detaching) {
    			destroy_component(nba, detaching);
    		}
    	};
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 13, 2, 355);
    			add_location(div1, file$6, 17, 2, 459);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-15pppwg");
    			add_location(main, file$6, 11, 0, 324);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Nba, Home, NavLink, url });
